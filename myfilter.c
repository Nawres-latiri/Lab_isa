...
const int b[NT]={-1,-4,-716,70,101,70,16,-7,-4,-1}; /// b array 

/*
const int a[NT-1]={-147, 52}; /// a array ( regressive part) 
*/
...
int myfilter(int x)
{
  ...
  y = 0;
  for (i=0; i<NT; i++)
    y += (sx[i]*b[i]) >> (NB+9) ; //(NB-1) bewteen 8-10
