...
fp=fopen('C:\Users\hugob\Desktop\Bureau\Dossier_Polito\deuxieme_annee\TP\ISA\LAB_1\samples.txt','w');
fprintf(fp,'%d\n', xq);
fclose(fp);

fp=fopen('C:\Users\hugob\Desktop\Bureau\Dossier_Polito\deuxieme_annee\TP\ISA\LAB_1\resultsm.txt', 'w');
fprintf(fp, '%d\n', yq);
fclose(fp);